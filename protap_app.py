...
COMPLETION_TYPES = ["Aktif Tapa / Active Plug", "Pasif Tapa / Passive Plug", "Tapasız / No Plug", "Dişli Tapa / Threaded Plug"]
GUIDEBAR_TYPES = ["Standard", "No", "Nipple", "Flow Through"]
NOZZLE_TYPES = ["Tee", "Straight", "Tee+Nipple"]
STANDARDS = ["ASME B31.4", "ASME B31.8"]
SPECIFICATIONS = [
  "ZORLU ENERJİ TR24Z-ST-M-111-0002",
  "GTCL",
  "İGDAŞ TKŞ A132-12",
  "BOTAŞ 4 - NGTL 0 - PL - P - 002-5010-R1",
]
...
def get_plug_height(completion_type, branch_inch):
  ...
  elif completion_type == "Tapasız / No Plug":
    return 0
  return 0
...
def run_calculation(params):
  ...
  if control_in2 < 0:
    ...
    r["result"] = "UYGUN DEĞİL/NOT SUITABLE!"
  ...
  if completion_type == "Tapasız / No Plug":
    plug_kg = 0
  else:
